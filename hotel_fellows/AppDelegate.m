...
//    NSLog(@"%@",[[[NSFileManager defaultManager] URLsForDirectory:NSDocumentDirectory  inDomains:NSUserDomainMask] lastObject]);
    ...
    NSLog(@"%@", [[[HotelService sharedService] coreDataStack]applicationDocumentsDirectory ] );
...
//    // The directory the application uses to store the Core Data store file. This code uses a directory named "dwm.codefellows.hotel_fellows" in the application's documents directory.
